# fresh-eyes-review: paste-in prompt (lite)
...
Generated from the fresh-eyes-review skill, lite version with the most-used personas. Don't edit this file; edit the skill and rebuild.
...
This lite version includes only some personas. If the document-type map calls for one that isn't included (appellate-judge, client-in-house-counsel, implementer-operations, insurance-claims-professional, judicial-law-clerk, mediator, public-press-reader, regulator-agency-staff), use the closest included persona and say so.
